...
! determine the number of solutions
  ...
  WRITE(UNIT=console,FMT="(20x,'Starting ',i3,' trial')",ADVANCE='NO') TotalNumberOfSolutions
  IF (TotalNumberOfSolutions.gt.1) WRITE(UNIT=console,FMT="('s')",ADVANCE='NO')
  WRITE(UNIT=console,FMT="('...')")
  FLUSH(console)
